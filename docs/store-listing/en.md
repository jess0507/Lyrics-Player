...
```
Lyrics Player is a lightweight music player built around your local files. Playing your music needs no network and no streaming — open the app, scan your device, and play. Even better: import lyrics, and auto-sync plain-text lyrics into line-by-line synced lyrics.
...
Download Lyrics Player and turn your local music files into the smoothest listening experience.
```
