...
class $AssetsIconGen {
  ...
  AssetGenImage get appLogoPng =>
      const AssetGenImage('assets/icon/app_logo.png');

  /// File path: assets/icon/app_logo.svg
  SvgGenImage get appLogoSvg => const SvgGenImage('assets/icon/app_logo.svg');

  /// File path: assets/icon/app_logo_512.png
  AssetGenImage get appLogo512 =>
      const AssetGenImage('assets/icon/app_logo_512.png');

  /// File path: assets/icon/app_logo_android12.png
